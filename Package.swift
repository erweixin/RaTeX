...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "RaTeXFFI",
            url: "https://github.com/erweixin/RaTeX/releases/download/v0.0.15/RaTeX.xcframework.zip",
            checksum: "8035d03dcd74de2da7b35a4224e16c210c6f0c12dfd39a16159aa03e77bbcaab"
        ),
