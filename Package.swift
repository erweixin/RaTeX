...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "RaTeXFFI",
            url: "https://github.com/erweixin/RaTeX/releases/download/v0.0.12/RaTeX.xcframework.zip",
            checksum: "1cc326fb24cfd58ee89b67739c2af60001561705efbbdcd353c3d060efbbf0d1"
        ),
