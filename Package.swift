...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "RaTeXFFI",
            url: "https://github.com/erweixin/RaTeX/releases/download/v0.0.11/RaTeX.xcframework.zip",
            checksum: "aefd9a5f145dc5d144540f8efbfb83a136c01c8a7a9a240c8b398e3d8fe0af01"
        ),
