...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "RaTeXFFI",
            url: "https://github.com/erweixin/RaTeX/releases/download/v0.1.3/RaTeX.xcframework.zip",
            checksum: "a0db5326683677a30d93120853e312bf63e99ab4b0f429d58eb0b44c99c15c38"
        ),
